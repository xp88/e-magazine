                    ...
                    <div class="row">
                        <div class="navbar-header no-padding">
                			<a class="navbar-brand" href="{{route('home')}}">
                			    <img src="admin/images/logo-dark.svg" alt="Options - Admin Template" class="logo">
                			</a>
                		...
                		<div class="collapse navbar-collapse" id="navbar-collapse-1">
                			...
                			<ul class="nav navbar-nav navbar-right" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                <li class="dropdown">
                					<a href="#" class="dropdown-toggle bg-primary tour-one" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-plus-circle"></i> Thêm <span class="caret"></span></a>
                						...
                						<li class="profile-menu bg-gray">
                						    <div class="">
                                                ...
                                                <div class="profile-name">
                                                    ...
                                                    <a href="pages-profile.html">Hồ sơ cá nhân</a>
                                                </div>
                                                <div class="clearfix"></div>
                						    </div>
                						</li>
                						<li><a href="#"><i class="fa fa-cog"></i> Cài đặt</a></li>
                						<li><a href="#"><i class="fa fa-sliders"></i> Thông tin tài khoản</a></li>
                						<li role="separator" class="divider"></li>
                						<li><a href="{{ route('logout') }}" class="color-danger text-center"><i class="fa fa-sign-out"></i> Thoát</a></li>
                					</ul>
                				</li>
                                <!-- /.dropdown -->
