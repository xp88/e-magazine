    ...
    <div class="sidebar-content">
        ...
        <div class="sidebar-nav">
            <ul class="side-nav color-gray">
                <li class="nav-header">
                    <span class="">Thư mục chính</span>
                </li>
                <li class=""><a href=" {{route('home')}}"><i class="fa fa-dashboard"></i> <span>Bảng điều khiển</span></a></li>
                
                <li class="nav-header">
                    <span class="">Quản lý</span>
                </li>
                <li class="has-children">
                    <a href=""><i class="fa fa-file-text"></i> <span>Loại Tin</span> <i class="fa fa-angle-right arrow"></i></a>
                    <ul class="child-nav">
                        <li><a href="{{route('quantriloaitin.index')}}"> <span>Danh sách loại tin</span></a></li>
                        <li><a href="{{route('quantriloaitin.create')}}"> <span>Thêm loại tin</span></a></li>
                ...
                <li class="has-children">
                    <a href="#"><i class="fa fa-paint-brush"></i> <span>Thể loại</span> <i class="fa fa-angle-right arrow"></i></a>
                    <ul class="child-nav">
                        <li><a href="{{route('quantritheloai.index')}}"><i class="fa fa-bank"></i> <span>Danh sách thể loại</span></a></li>
                        <li><a href="{{route('quantritheloai.create')}}"><i class="fa fa-bell"></i> <span>Thêm thể loại</span></a></li>
                ...
                <li class="has-children">
                    <a href="#"><i class="fa fa-paint-brush"></i> <span>Tin</span> <i class="fa fa-angle-right arrow"></i></a>
                    <ul class="child-nav">
                        <li><a href="{{route('quantritin.index')}}"><i class="fa fa-bank"></i> <span>Danh sách tin</span></a></li>
                        <li><a href="{{route('quantritin.create')}}"><i class="fa fa-bell"></i> <span>Thêm tin</span></a></li>
                        <!-- <li><a href="color-success.html"><i class="fa fa-check"></i> <span>Success Color</span></a></li>
                        <li><a href="color-warning.html"><i class="fa fa-info"></i> <span>Warning Color</span></a></li> -->
                    </ul>
                </li>
